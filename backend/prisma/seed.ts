...
async function main() {
  ...
  const usersData = [
    {
      name: 'Laura García', email: 'laura1@correo.com', city: 'Madrid', budget: 500, lifestyle: 'Trabajador remoto', age: 24, avatarUrl: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=300&q=80',
    ...
    {
      name: 'Carlos Martínez', email: 'carlos1@correo.com', city: 'Valencia', budget: 450, lifestyle: 'Estudiante', age: 22, avatarUrl: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=300&q=80',
    ...
    {
      name: 'Marcos Ruiz', email: 'marcos1@correo.com', city: 'Sevilla', budget: 550, lifestyle: 'Tranquilo y casero', age: 26, avatarUrl: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=300&q=80',
    ...
    {
      name: 'Elena Gómez', email: 'elena1@correo.com', city: 'Madrid', budget: 600, lifestyle: 'Deportista', age: 25, avatarUrl: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=300&q=80',
    ...
    {
      name: 'Javier Soto', email: 'javi1@correo.com', city: 'Barcelona', budget: 700, lifestyle: 'Nocturno', age: 23, avatarUrl: 'https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?auto=format&fit=crop&w=300&q=80',
    ...
    {
      name: 'Sara Jiménez', email: 'sara1@correo.com', city: 'Valencia', budget: 400, lifestyle: 'Madrugador', age: 19, avatarUrl: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=crop&w=300&q=80',
    ...
    {
      name: 'Daniel Blanco', email: 'dani1@correo.com', city: 'Sevilla', budget: 500, lifestyle: 'Trabajador remoto', age: 24, avatarUrl: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=300&q=80',
    ...
    {
      name: 'Clara del Bosque', email: 'clara1@correo.com', city: 'Bilbao', budget: 450, lifestyle: 'Social y activo', age: 20, avatarUrl: 'https://images.unsplash.com/photo-1524504388940-b1c1722653e1?auto=format&fit=crop&w=300&q=80',
    ...
    {
      name: 'Víctor R.', email: 'vic1@correo.com', city: 'Zaragoza', budget: 350, lifestyle: 'Estudiante', age: 21, avatarUrl: 'https://images.unsplash.com/photo-1521119989659-a83eee488004?auto=format&fit=crop&w=300&q=80',
    ...
    {
      name: 'Luis Méndez', email: 'luis1@correo.com', city: 'Málaga', budget: 550, lifestyle: 'Trabajador remoto', age: 25, avatarUrl: 'https://images.unsplash.com/photo-1480455624313-e29b44bbfde1?auto=format&fit=crop&w=300&q=80',
    ...
    {
      name: 'Carmen Torres', email: 'carmen1@correo.com', city: 'Barcelona', budget: 750, lifestyle: 'Tranquilo y casero', age: 26, avatarUrl: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=300&q=80',
