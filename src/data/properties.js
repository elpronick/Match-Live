export const properties = [
  {
    ...
    image:
      "linear-gradient(135deg, rgba(46, 28, 18, 0.12), rgba(46, 28, 18, 0.35)), url('https://images.pexels.com/photos/20725941/pexels-photo-20725941.jpeg')",
  ...
  },
  {
    ...
    image:
      "linear-gradient(135deg, rgba(21, 25, 41, 0.12), rgba(21, 25, 41, 0.34)), url('https://images.pexels.com/photos/20725943/pexels-photo-20725943.jpeg')",
    meta: ["3 compis", "Piso reformado", "WiFi top"],
    perks: ["Balcón", "Desk setup", "Supermercado cerca"],
  },
  {
    id: 3,
  ...
  },
  {
    ...
    image:
      "linear-gradient(135deg, rgba(62, 31, 18, 0.14), rgba(62, 31, 18, 0.36)), url('https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?auto=format&fit=crop&w=1200&q=80')",
